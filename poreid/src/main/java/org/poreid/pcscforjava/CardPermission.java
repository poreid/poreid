...
public class CardPermission extends Permission {
    ...
    private final static int A_RECONNECT            = 0x40;
    private final static int A_DISCONNECT           = 0x80;
    private final static int A_GET_ATTRIB           = 0x100;
    private final static int A_SET_ATTRIB           = 0x200;

    // sum of all the actions above
    private final static int A_ALL                  = 0x3ff;
    ...
    private final static String S_RECONNECT            = "reconnect";
    private final static String S_DISCONNECT           = "disconnect";
    private final static String S_GET_ATTRIB           = "getAttrib";
    private final static String S_SET_ATTRIB           = "setAttrib";
    ...
    private static int getMask(String actions) {
        ...
        for (int i = 0; i < ARRAY_STRINGS.length; i++) {
            if (actions.equals(ARRAY_STRINGS[i])) {
