...
public abstract class CardChannel {
    ...
    public abstract ResponseAPDU transmit(CommandAPDU command,
            boolean bAutoGetResp, boolean bAutoReissue) throws CardException;
     ...
     * @throws CardException if the card operation failed
     */
    public abstract int transmit(ByteBuffer command, boolean bAutoGetResp, 
