...
/**
 * The set of terminals supported by a TerminalFactory.<br />
 * This class allows applications to enumerate the available {@link 
 * CardTerminals CardTerminals}, obtain a specific {@link CardTerminal 
 * CardTerminal}, or wait for the insertion or removal of cards.<br />
 *
 ...
 * {@linkplain TerminalFactory#terminals terminals}.
 *
 * @see TerminalFactory
 * @see CardTerminal
 *
...
public abstract class CardTerminals{
     ...
     * terminal exists.
     *
     * @param name the name of the {@link CardTerminal CardTerminal} object.
     * 
     ...
     * @throws CardException if the card operation failed
     */
    public abstract void closeContext() throws CardException;
     ...
     */
    public abstract void updateCardTerminalsListByEvent() throws CardException;
    
    /**
     * Returns if the {@link CardTerminals CardTerminals} object is managed
     * by Plug & Play or not.
     * @return false if the object does not support Plug & Play mode.
     * <br /> true otherwise.
     * @throws CardException if a card operation failed
     */
    public abstract boolean isPlugAndPlaySupported() throws CardException;
