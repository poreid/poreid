...
public abstract class TerminalFactorySpi {
     ...
     * TerminalFactory.getInstance()} methods and receives the 
     * <code>params</code> object specified by the application.
     */
     ...
     *
     * @return true if the deletion has been correctly made.<br />
     * false otherwise.
     */    
    protected abstract boolean destroyTerminals();
}
