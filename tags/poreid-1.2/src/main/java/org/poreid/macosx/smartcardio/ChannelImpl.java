...
final class ChannelImpl extends CardChannel {
    ...
    private final static boolean t0GetResponse =
        getBooleanProperty("org.poreid.macosx.smartcardio.t0GetResponse", true);

    private final static boolean t1GetResponse =
        getBooleanProperty("org.poreid.macosx.smartcardio.t1GetResponse", true);

    private final static boolean t1StripLe =
        getBooleanProperty("org.poreid.macosx.smartcardio.t1StripLe", false);
